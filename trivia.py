...
def play_game(): 
   for question,choices,correct in [
           ...
           ["During the ballroom scene of Beauty & the Beast, what color is her dress?", ["a. Gold", "b. Silver", "c. Bronze", "d. None of the above"], "a"],
           ["In the Little Mermaid, what is the name of the dog?", ["a. Dog", "b. Pluto", "c. Max", "d. Mike"], "c"],
           ...
           ["What is the name of the mice in Cinderella?", ["a. Jesse and Goose", "b. Jess and Jack-Jack", "c. Gus and Jaq", "d. Wes and Jess"], "c"],
           ["In Monsters Inc., what is the full name for Sulley?", ["a. Jim A Sullivan", "b. Sullivan", "c. J P Sullivan", "d. James P Sullivan"], "d"]
   ]: 
        print(question)
        print(choices)
